...
/**
* Esta Classe realiza a configuracao, da cor a ser exibida
* Pelo cursor e determina o evento a ser realizado pelo objeto
* 
* @author Ian
* @author Saul Melo
* @author Yuri
...
public class Configurations{
   ...
   /**
   * O Construtor da classe que especifica as configuracoes de evento,
   * E cor exibida pelo cursor 
   *
